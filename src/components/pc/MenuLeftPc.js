              ...
              <div style={{width: '175px', height: '500px', position: 'fixed'}}>
                <div className="cursor" style={{width: '100%', background: '#fff', borderRadius: '12px', padding: '16px', display: 'flex', paddingRight: '0 !important'}}>
                  <div className="mr-2" style={{width: '35px', height: '35px'}}>
                    <img alt="" src="images/icons/logo1.svg" width="100%" height="100%" style={{borderRadius: '8px'}} />						
                  </div>
                ...
                <NavLink exact to="/" onClick={props.onProgress}>
                  <div className={props.setActive==="home"?"menu-active":""} style={{width: '100%', height: '60px', borderLeft: '3px solid #fff'}}>
                    <div style={{width: '82%', height: '60px', margin: 'auto', padding: '20px 10px 30px 10px', display: 'flex', borderBottom: '1px solid #f2f3f7'}}>
                      <div className="mr-3" style={{width: '22px', height: '22px'}}>
                        <img alt="" src="images/icons/ic_home.svg" width="100%" style={{marginTop: '-8px'}} />
                      </div>
                      <p className="font-weight-bold" style={{fontSize: '90%', color: '#526782'}}>Home</p>
                    </div>
                  </div>
                  </NavLink>
                  <NavLink exact to="/nft-card" onClick={props.onProgress}>
                  <div className={props.setActive==="nftcard"?"menu-active":""} style={{width: '100%', height: '60px', borderLeft: '3px solid #fff'}}>
                    <div style={{width: '82%', height: '60px', margin: 'auto', padding: '20px 10px 30px 10px', display: 'flex', borderBottom: '1px solid #f2f3f7'}}>
                      <div className="mr-3" style={{width: '22px', height: '22px'}}>
                        <img alt="" src="images/icons/ic_card.svg" width="100%" style={{marginTop: '-8px'}} />
                      </div>
                  ...
                  <div className={props.setActive==="token"?"menu-active":""} style={{width: '100%', height: '60px', borderLeft: '3px solid #fff'}}>
                    <div style={{width: '82%', height: '60px', margin: 'auto', padding: '20px 10px 30px 10px', display: 'flex', borderBottom: '1px solid #f2f3f7'}}>
                      <div className="mr-3" style={{width: '22px', height: '22px'}}>
                        <img alt="" src="images/icons/ic_token.svg" width="100%" style={{marginTop: '-8px'}} />
                      </div>
                  ...
                  <div className={props.setActive==="roadmap"?"menu-active":""} style={{width: '100%', height: '60px', borderLeft: '3px solid #fff'}}>
                    <div style={{width: '82%', height: '60px', margin: 'auto', padding: '20px 10px 30px 10px', display: 'flex', borderBottom: '1px solid #f2f3f7'}}>
                      <div className="mr-3" style={{width: '22px', height: '22px'}}>
                        <img alt="" src="images/icons/ic_road_map.svg" width="100%" style={{marginTop: '-8px'}} />
                      </div>
                  ...
                  <div className={props.setActive==="whitepaper"?"menu-active":""} style={{width: '100%', height: '60px', borderLeft: '3px solid #fff'}}>
                    <div style={{width: '82%', height: '60px', margin: 'auto', padding: '20px 10px 30px 10px', display: 'flex', borderBottom: '1px solid #f2f3f7'}}>
                      <div className="mr-3" style={{width: '22px', height: '22px'}}>
                        <img alt="" src="images/icons/ic_paper.svg" width="100%" style={{marginTop: '-8px'}} />
                      </div>
                  ...
                  <div className={props.setActive==="whitelist"?"menu-active":""} style={{width: '100%', height: '60px', borderLeft: '3px solid #fff'}}>
                    <div style={{width: '82%', height: '60px', margin: 'auto', padding: '20px 10px 30px 10px', display: 'flex', borderBottom: '1px solid #f2f3f7'}}>
                      <div className="mr-3" style={{width: '22px', height: '22px'}}>
                        <img alt="" src="images/icons/ic_user.svg" width="100%" style={{marginTop: '-8px'}} />
                      </div>
                  ...
                  <div className={props.setActive==="playgame"?"menu-active":""} style={{width: '100%', height: '60px', borderLeft: '3px solid #fff'}}>
                    <div style={{width: '82%', height: '60px', margin: 'auto', padding: '20px 10px 30px 10px', display: 'flex', borderBottom: '1px solid #f2f3f7'}}>
                      <div className="mr-3" style={{width: '22px', height: '22px'}}>
                        <img alt="" src="images/icons/ic_note.svg" width="100%" style={{marginTop: '-8px'}} />
                      </div>
